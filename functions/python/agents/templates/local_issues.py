...
1.  **전체 뼈대 (분석 구조): {analytical_structure.name}**
    - 지시사항: {analytical_structure.instruction}

2.  **핵심 기술 (설명 전술): {explanatory_tactic.name}**
    - 지시사항: {explanatory_tactic.instruction}
