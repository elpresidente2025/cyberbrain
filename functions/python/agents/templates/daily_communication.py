...
<source_constraint priority="critical" description="소재 순도 규칙 — 절대 어김 금지">
  <!-- 이 원칙의 출처는 leadership.py다. 특정 인물명을 템플릿에 박지 않되, 철학 자체는 leadership.py에서 가져온다. -->
  <philosophy>좋은 생활정치 글의 핵심 원칙 — '현장에서 직접 확인한 경험'과 '화려한 말보다 실질적 변화' — 은 화자가 직접 경험하고 말한 것에서만 소재를 취해야 함을 요구한다. 프로필 정책 목록을 끌어다 섹션을 채우는 것은 '화려한 정책 나열'로 이 원칙과 충돌한다.</philosophy>
