...
<structure_guide mode="strict">
  ...
  <paragraph_structure priority="critical">
    ...
    결론 3문단: (1) 핵심 결론 재진술 (110~140자) (2) 종합 의의 (110~140자) (3) 전망·다짐 (110~140자).
    사실만 나열하고 끝나는 문단, 한두 문장으로 끝나는 문단, 2문단 이하로 끝나는 섹션은 불합격입니다.
    각 섹션의 첫 문장(= 첫 번째 문단의 첫 문장)을 접속사('또한/아울러/나아가/한편/더불어')나 지칭 표현('이는/이것은/이러한/이와 같은/이를 통해/이를 위해/그로 인해/그런 점에서/이에')으로 시작하지 마십시오. 각 섹션은 해당 섹션의 핵심 주어·주제어로 독립적으로 시작하십시오.
  </paragraph_structure>
