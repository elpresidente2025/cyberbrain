...
def _build_style_generation_guard(
    ...
    tone_rules: List[str] = []
    sentence_type_rules = [
        "화자의 경험·행동·정책 전망은 직접 서술할 수 있지만, 그것이 독자·주민·시민의 반응을 만들었다고 근거 없이 해설하지 말 것.",
        "삶·경험·이력·경영 경력으로 자신의 정체성·역량을 증명하거나 보여준다고 결론내리지 말 것. 경험은 사실로 끝내고 판단은 독자에게 맡길 것.",
        "여론조사 수치나 결과를 쓴 뒤에는 그것이 시민의 주목·기대·열망을 뜻한다고 해석하지 말고, 'A% 대 B%' 같은 확인 가능한 사실에서 멈출 것.",
        "수치를 쓴 뒤 감탄형 해설이나 의미 단정을 붙이지 말 것. 수치를 썼다면 그 문장 안에서 해석을 덧붙이지 말 것.",
        "'단순한/단순히 ... 아니라/아닌/넘어/그치지 않고'처럼 앞 절을 깎아내리고 뒤 절을 세우는 부정-반전 프레임 자체를 쓰지 말 것. 명사를 바꿔도 같은 실패다. 남길 주장만 바로 말할 것.",
        "'더 나은 미래', '더 나은 내일', '더 나은 방향' 같은 범용 개선 구문 대신 등록된 대체어 또는 구체 목표를 직접 쓸 것.",
        "시민들이 화자의 비전·진정성·역량에 감동했다거나 신뢰를 보낸다고 추측하지 말고, 확인 가능한 사실·행동·예측만 쓸 것.",
        "타인의 반응이나 영향은 여론조사 수치, 언론 보도, 공개 발언, 직접 인용 같은 검증된 근거가 없는 한 기정사실로 쓰지 말 것.",
        "타인의 반응을 '공감을 얻고 있다', '마음에 닿고 있다고 믿는다', '인지도가 확장되고 있다'처럼 믿음·추정형으로 완화해도 같은 금지다.",
        "'이 흐름은 이름이 더 알려지고 있음을 보여준다'처럼 화자의 인지도 확장을 해설하지 말고, 확인 가능한 수치와 사실만 직접 적을 것.",
        "'조금씩 확실히 알려지고 있다' 같은 인지도 자기서술을 반복하지 말고, 필요하면 여론조사 수치 한 번으로만 말할 것.",
        "겸손 클리셰를 직설적 자신감 문장과 섞지 말 것. 이 문체는 자신감 있는 선언형을 유지할 것.",
        "경쟁자 이름을 기준점으로 '와는/과는 달리', '차별화된', '비해' 같은 직접 비교 구문을 만들지 말 것. 화자의 역량은 화자 자신의 사실로만 서술할 것.",
        "경쟁자 이름을 직접 비교 도입부로 쓰지 말 것. 경쟁자를 꺼냈다면 사실관계·수치 설명에만 쓰고, 우위 비교 문장으로 넘기지 말 것.",
        "'시민 여러분께서 저의 역량과 진정성을 알아봐 주셨다', '높이 평가해 주셨다', '믿어주셨다'처럼 타인의 판단을 대신 보고하지 말 것.",
        "'이러한 경험이 저에게 전문성을 부여했다'처럼 경험으로 자기 역량을 인증하지 말고, 경험 자체를 사실로 끝낼 것.",
        "'이러한 경험이 리더십을 길러주었다', '이러한 노력이 시민에게 닿아 긍정적 변화를 만들고 있다고 확신한다'처럼 경험과 노력의 효과를 스스로 단정하지 말 것.",
        "'경험이 저에게 통찰력·전문성·실행력·자산을 제공했다'처럼 경험을 자기 인증 문장으로 잇지 말 것. 경험 다음 문장은 당시 사실·판단·행동으로만 이을 것.",
        "'저의 비전이 새로운 도약을 이끌 것이라고 확신한다'처럼 자신의 비전 효과를 스스로 인증하지 말 것.",
        "같은 경력·학력 문장을 본문과 결론에서 반복하지 말 것. 핵심 이력 나열은 원고당 한 번이면 충분하다.",
        "동일 경력은 두 개 이상의 섹션에 반복하지 말 것. 경력은 원고 전체에서 한 번만 등장해야 한다.",
        "긴 공약 목록은 본문에서 한 번만 펼치고, 결론에서는 핵심 1~2개만 압축해 다시 말할 것. 같은 정책 나열을 통째로 반복하지 말 것.",
        "프로젝트 관리 보고서처럼 '우선순위를 설정하고, 자원·일정을 현실적으로 맞춘다'는 문장을 쓰지 말 것. 본문에는 문제 확인, 행동, 해법만 남길 것.",
        "등록된 시그니처가 있으면 정확형으로만 쓰고, 띄어쓰기·이름 생략·조사 추가로 변형하지 말 것.",
        "화자 이름 뒤에 비교 조사 도를 붙이지 말 것. 이름도 이깁니다 대신 이름, 이깁니다 또는 저는 충분히 이깁니다처럼 쓸 것.",
        "'단순히/단순한 ... 아니라/아닌/넘어/머무르지 않고' 같은 추상 대비 문형을 쓰지 말고, 남길 주장만 직접 선언할 것.",
        "'단순히 이론적인 정책이 아닌'처럼 앞 절을 부정하는 말로 시작하지 말고, 실제 해법을 바로 말할 것.",
        "대상을 깎아내리는 단순 프레임도 같은 금지다.",
        "같은 부정-반전 프레임을 명사만 바꿔 반복하는 변형도 모두 같은 금지다.",
        "성과를 자기 역량 인증으로 결론내리지 말 것.",
    ]
...
<style_generation_guard priority="high" confidence="{confidence:.2f}">
  ...
  <rule id="allow_forecast_but_not_audience_reaction">화자 자신의 경험·행동·정책 전망은 직접 서술할 수 있다. 단, 그것이 시민·타인에게 미치는 영향이나 반응은 여론조사 수치·언론 보도·공개 발언·직접 인용 같은 검증된 사실이 아닌 이상 기정사실로 쓰지 말 것.</rule>
