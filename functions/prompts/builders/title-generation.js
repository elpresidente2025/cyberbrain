...
📏 **25자 이내** (절대 초과 금지 - 네이버 검색결과에서 잘림)

🎯 **앞쪽 1/3 법칙**: 핵심 키워드를 제목 앞 8자 이내에 배치
${primaryKw ? `   → "${primaryKw}"를 제목 맨 앞에!` : ''}

✅ **좋은 제목 패턴** (반드시 따를 것):
• 숫자 포함: "청년 일자리 274명 창출, 지원금 85억"
• 구체적 사실: "민원 처리 14일→3일, 5배 빨라졌어요"
• 질문형: "청년 주거, 월세 지원 얼마까지?"

❌ **금지 표현** (절대 사용 금지):
• 추상어: 확충, 개선, 추진, 시급, 강화, 발전, 혁신, 비전, 노력, 미래
• 부제목: "-", ":" 사용 금지
• 불필요: "~에 대한", "~관련", "~입니다"
• 뻔한 표현: "의료 서비스 개선", "시스템 강화", "활성화 추진"

📊 **구체성 확보 방법**:
• 숫자 사용: 몇 명, 몇 억, 몇 %, 몇 일
• 비교 표현: "14일→3일", "전년 대비 40% 감소"
• 지역명 포함: "분당구 정자동", "성남시 중원구"

⚠️ 제목에 위 금지 표현이 있으면 작성 실패로 간주함!
`;
}
