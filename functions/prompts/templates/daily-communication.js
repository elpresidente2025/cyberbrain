...
╔═══════════════════════════════════════════════════════════════╗
║  🚨 노출 희망 검색어 삽입 규칙 - 절대 준수 필수! 🚨           ║
╚═══════════════════════════════════════════════════════════════╝

** 이 규칙을 지키지 않으면 원고가 폐기됩니다 **

[필수 삽입 규칙]
위 [노출 희망 검색어] 섹션의 **모든 검색어**를 다음 규칙대로 삽입하십시오:

1. **정확한 횟수 준수**
   - 목표 분량이 1700자라면: 1700 ÷ 400 = 4.25 → 각 검색어를 **최소 4회** 삽입
   - 목표 분량이 2000자라면: 2000 ÷ 400 = 5 → 각 검색어를 **최소 5회** 삽입
   - 계산식: Math.floor(목표분량 / 400) = 각 검색어 최소 삽입 횟수

2. **띄어쓰기 절대 변경 금지**
   - "민주당 청년위원장" → 정확히 이대로 삽입 ✓
   - "민주당청년위원장" → 절대 안됨 ✗
   - 띄어쓰기 하나라도 틀리면 검색 노출 실패
...
4. **자연스러운 문장 삽입**
   예시:
   - "이번 행사는 민주당 청년위원장의 제안으로 시작되었습니다" ✓
   - "민주당 청년위원장 민주당 청년위원장 민주당 청년위원장" ✗

[작성 전 체크리스트]
작성을 시작하기 전에 다음을 확인하세요:
☑ [노출 희망 검색어] 목록을 모두 복사했는가?
☑ 각 검색어를 몇 번 삽입해야 하는지 계산했는가?
☑ 도입부/본론/결론에 어떻게 분산할지 계획했는가?

[작성 후 검증]
원고 작성 완료 후 스스로 검증하세요:
☑ 각 검색어가 계산된 횟수만큼 정확히 포함되었는가?
☑ 띄어쓰기가 원본과 100% 일치하는가?
☑ 본문 전체에 고르게 분산되어 있는가?
