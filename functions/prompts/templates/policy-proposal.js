...
[🔥 수사학적 테크닉: '비유적 점층법'] (필수 적용)
이 글의 설득력을 극대화하기 위해, **'수사학적 반복'과 '선명한 비유'**를 반드시 사용하십시오.
1. **[구조] 3단 점층 (Crescendo)**: 문단 말미나 핵심 주장 부분에서 동일한 문장 구조를 3번 반복하며 의미를 확장하십시오. (예: "우리는 ~할 것입니다. 우리는 ~할 것입니다. 우리는 ~할 것입니다.")
2. **[표현] 사물 비유 (Metaphor)**: 추상적인 개념(노력, 지지)을 구체적인 사물(예: 횃불, 디딤돌, 방패, 마중물)에 빗대어 표현하십시오. (단, 상투적인 표현은 지양하고 문맥에 맞는 신선한 비유 사용)
3. **[대비] 극적인 대조 (Contrast)**: '과거의 문제'와 '미래의 해결'을 선명하게 대비시켜 변화의 의지를 부각하십시오. (예: "과거의 어둠을 걷어내고, 내일의 새벽을 열겠습니다.")

[🔥 수사학적 테크닉: '비장한 헌신과 결의'] (필수 적용)
제공된 텍스트의 '비장미(Tragic Beauty)'와 '헌신적 태도'를 구현하기 위해 다음 기법을 반드시 사용하십시오.
1. **[구조] 3단 점층 (Progressive Repetition)**: 문단 말미나 핵심 다짐 부분에서 **동일한 문장 구조를 3번 반복**하십시오.
   - 예시 구조: "우리는 언제나 그랬듯이, (A)가 되겠습니다. 우리는 언제나 그랬듯이, (B)가 되겠습니다. 우리는 언제나 그랬듯이, (C)가 되겠습니다."
2. **[표현] 사물 비유 (Concrete Metaphor)**: 추상적인 '지지'나 '노력' 대신, 화자의 헌신을 보여주는 **구체적이고 헌신적인 사물**에 빗대어 표현하십시오. (예: 보도블럭, 횃불, 생수통, 거름, 디딤돌, 방패 등)
3. **[대비] 극적인 반전 (Dramatic Contrast)**: '이별/절망'의 이미지를 '만남/희망'의 이미지와 대비시켜 감동을 극대화하십시오. (예: "떠나보내지만, 맞이할 것입니다", "절망인 줄 알았으나, 희망이었습니다")
