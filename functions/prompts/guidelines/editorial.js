...
const SUBHEADING_STRATEGIES = {
  ...
  QUESTION_HOOK: {
    ...
    name: '질문형 소제목 전략',
    instruction: `
[소제목 작성 전략: 마지막 빼고 모두 질문형]

■ 규칙
- 원고의 소제목(H2) 2~3개 중 **마지막(마무리 섹션)을 제외한 모든 소제목**을 질문형(?)으로 작성
- 마지막 소제목만 명사형/서술형으로 마무리 (예: "함께 만들어갈 미래", "앞으로의 다짐")
- 질문형 소제목은 독자의 호기심을 자극하고, AI 검색엔진이 답변으로 인식하게 유도

■ 질문형 소제목 공식
- "[지역/분야], 무엇이 문제인가?"
- "[대상]은 왜 [현상]하는가?" (예: "청년들은 왜 떠나는가?")
- "어떻게 [문제]를 해결할 것인가?"
- "[지역/분야], 어떻게 바꿀 것인가?"
- "[숫자], 어떻게 줄일(늘릴) 것인가?"

■ 주의: 비하적 프레임 금지
- "왜"는 사용 가능하나, 비하적 표현과 결합 금지
- ✅ "청년들은 왜 떠나는가?" (직관적, OK)
- ✅ "부산 의료, 무엇이 문제인가?" (객관적, OK)
- ❌ "왜 이 지경인가?" (비하적)
- ❌ "왜 망했는가?" (비하적)
- ❌ "왜 이 꼴이 됐는가?" (비하적)

■ 구조 예시 (소제목 3개인 경우)
<h2>부산 의료, 무엇이 문제인가?</h2> ← 질문형
<h2>어떻게 바꿀 것인가? (4대 정책 제안)</h2> ← 질문형
<h2>함께 만들어갈 부산의 미래</h2> ← 마무리 (명사형)

■ 변환 예시
❌ "현황 분석" → ✅ "지금 무엇이 문제인가?"
❌ "청년 유출 현황" → ✅ "청년들은 왜 떠나는가?"
❌ "정책 제안 4가지" → ✅ "어떻게 바꿀 것인가? (4대 정책 제안)"
❌ "교통 개선 방안" → ✅ "출퇴근 1시간 30분, 어떻게 줄일 것인가?"
❌ "의료 인프라 확충" → ✅ "병원 없는 동네, 어떻게 해결할 것인가?"

■ 효과
- AI 검색엔진이 "How/Why 질문에 대한 답변"으로 인식
- 독자의 호기심 자극, 스크롤 유도, 클릭률 상승
- 글의 논리적 구조 강화 (문제 제기 → 해결책 → 비전)
`
  }
};
