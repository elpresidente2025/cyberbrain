...
if [ ! -f "$COMPONENTS_TARBALL" ]; then
  echo "Warning: shadcn-components.tar.gz not found in script directory"
  echo "   Expected location: $COMPONENTS_TARBALL"
  echo "   Will create project without pre-built components"
...
echo ""
echo "To add shadcn components manually:"
