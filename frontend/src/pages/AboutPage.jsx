...
유권자가 "우리 동네 의원" 검색할 때
의원님 글이 노출될 확률을 비약적으로 높여 줍니다.
제목·본문을 네이버가 좋아하는 형태로 맞추고,
검색 노출 점수가 기준 이하면
AI가 알아서 고쳐서 내보냅니다.`
    },
    {
  ...
  const allFAQs = [
    {
      ...
      answer: '일반 AI와 달리 정치 콘텐츠에 특화되어 있습니다. 준법 가드레일, 의원님 문체 학습, 장르별 구조 선택, 네이버 검색 최적화까지 정치인에게 필요한 기능만 모았습니다.'
    },
    {
      id: 'faq-1',
    ...
    },
    {
      ...
      answer: '유권자가 네이버에서 검색했을 때 의원님 글이 노출될 확률을 비약적으로 높여 줍니다. 제목과 본문을 자동으로 맞추고, 기준 점수를 못 넘기면 AI가 알아서 고쳐서 내보냅니다.'
    },
    {
      id: 'faq-5',
